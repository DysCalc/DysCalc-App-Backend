...
def get_lesson_from_qwen(ml_data_string):
    ...
    CORE RULES:
    1. SEVERITY SCAN: Scan data for the highest decimal score in "Domain Severity" or "Task Importance." Base the lesson ONLY on that skill[cite: 1033, 1127].
    ...
    3. PEDAGOGY MATCH: For "Digit-Dot Matching" or "Number Comparison," do NOT use addition/subtraction equations. Focus on counting and matching[cite: 1114].
    4. CONFIDENCE SCALING: If "Confidence" is >= 0.85, provide extreme scaffolding with microscopic steps and repetition[cite: 1128].
    5. EXPLAINABILITY: Include the "Decision Path" in the rationale for teacher review[cite: 1106, 1132].
...
def format_with_cloud_llm(qwen_messy_text, ml_data_string):
    ...
    REQUIRED SCHEMA:
    {
        ...
        "decision_path_rationale": "The explicit rule path from C4.5 algorithm for teacher review",
        ...
        "scaffolded_practice": [
            {"problem": "Prob 1", "hint": "Scaffolded hint"},
            {"problem": "Prob 2", "hint": "Scaffolded hint"},
            {"problem": "Prob 3", "hint": "Scaffolded hint"},
            {"problem": "Prob 4", "hint": "Scaffolded hint"}
        ],
